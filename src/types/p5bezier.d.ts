...
declare module '@/utils/p5bezier' {
  namespace p5bezier {
    ...
    export function newBezier(pointList: Array<Point>, closeType?: CloseType, accuracy?: number): void
    export function newBezierObj(pointList: Array<Point>, closeType: CloseType, accuracy: number): BezierCurve
    ...
    export class BezierCurve{
      constructor(pL: Array<Point>, closeT: CloseType, tI: number, bD:bezierDimension, vL: null)
      ...
      move(x: number, y: number, z: number | null, toDraw: boolean, dash: dash): void
