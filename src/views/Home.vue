...
const navList = ref<Array<NavItem>>([
  { title: 'cssTrick-StarRate', link: '/starRate' },
  ...
  { title: 'p5-randomMaze', link: '/maze' },
  { title: 'p5-gradientLine', link: '/gradientLine' },
  ...
  { title: 'p5-disperseParticle2', link: '/disperseParticle2' },
  { title: 'p5-snake', link: '/snake' },
  // { title: 'p5-corssLine', link: '/crossLine' },
  // { title: 'p5-NoisePixels', link: '/noisePixels' },
  { title: 'p5-LightBall', link: '/lightBall' },
  { title: 'p5-FlappyBird', link: '/flappyBird' },
