import{d as w,r,w as y,a as R,c as v,o as d,b as h,e as f,n as g,u as x,f as k,t as C,g as B,_ as D,h as M,i as S,F as $,j as z,k as P,m as Y}from"./index-ZaEf4npp.js";import{p as E}from"./disco_communism-NN-qA4tW.js";import"./p5.min-7Fs9b1YB.js";const L={class:"fit-content flex flex-col items-center pointer-events-none"},T=w({__name:"ReverseCard",props:{name:null,conDomRect:null,bg:null,show:{type:Boolean}},setup(c){const n=c,s=r(),l=r("");y(()=>{if(!n.conDomRect||!s.value)return;const{top:o,left:a}=s.value.getBoundingClientRect(),{top:_,left:b}=n.conDomRect;l.value=`-${a-b}px -${o-_}px`});const e=r(!!n.show);R(()=>n.show,o=>{e.value=o});function p(){e.value=!0}function i(){e.value=!1}const m=v(()=>({"box-shadow":e.value?"0px 0px 10px rgb(210, 175, 210)":"0px 0px 8px rgba(0, 0, 0, 1)"})),t=v(()=>({transform:e.value?"rotateY(0deg)":"rotateY(180deg)"})),u=v(()=>{var o;return{transform:e.value?"rotateY(180deg)":"rotateY(0deg)","background-position":l.value,"background-size":`${((o=n.conDomRect)==null?void 0:o.width)??0}px`,"background-image":`url(${n.bg})`}});return(o,a)=>(d(),h("div",{ref_key:"card",ref:s,class:"card font-ani",style:g(x(m)),onMousemove:p,onMouseout:i},[f("div",{class:"bg pointer-events-none",style:g(x(u))},null,4),f("div",{class:"content pointer-events-none",style:g(x(t))},[f("div",L,[k(C(c.name)+" ",1),f("div",{class:B(["h-2px m-t-2px bg-#fff transition-duration-0.35s transition-delay-0.3s",e.value?"w-full":"w-0"])},null,2)])],4)],36))}}),j=D(T,[["__scopeId","data-v-e4c5c7a1"]]);function F(c){return new Promise(n=>{setTimeout(n,c)})}const I=w({__name:"reverseCardPic",setup(c){const n=`一个幽灵，共产主义的幽灵，在欧洲游荡。为了对这个幽灵进行神圣的围剿，旧欧洲的一切势力，教皇和沙皇、梅特涅和基佐、法国的激进派和德国的警察，都联合起来了。
