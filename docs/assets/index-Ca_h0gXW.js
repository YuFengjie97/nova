import{d as w,r as b,j as z,V as m,R as t,aQ as M,ai as R,Y as A,e as S,q as V,o as q,B}from"./index-Dk52mj26.js";import{i as I}from"./initThree-CPuUtzyO.js";import{A as P}from"./AudioController-Bj40XwAW.js";import"./OrbitControls-Rz_z-Chd.js";import"./initStats-z-qGLZo8.js";import"./audio-sugarCrush-1d8eZUIK.js";const T=`varying vec2 vUv;
...
}`,p=512,Q=w({__name:"index",setup(F){const a=b();let c;z(()=>{const{scene:e,renderWrap:l}=I(a.value),{width:v,height:u}=a.value.getBoundingClientRect(),o={iResolution:{value:new m(v,u)},iMouse:{value:new m(v/2,u/2)},iTime:{value:0},colorChannel:{value:{a:new t(0,.5,.5),b:new t(0,.5,.5),c:new t(0,.5,.333),d:new t(0,.5,.667)}},radius:{value:0}},g=new M({uniforms:o,vertexShader:T,fragmentShader:k}),x=new R(1e3,1e3),s=new A(x,g);s.position.set(0,0,10),e.add(s);function y(n,r){const C=Math.floor(n/r),d=[];for(let i=0;i<n;i+=C)d.push(i);return d}const _=y(p/2,13);function f(n){const r=c.getAudioData()[_[n]];return B(r,0,255,0,1)}l(()=>{const n=performance.now()/1e3;o.iTime.value=n,c&&(o.colorChannel.value.a.x=f(5)*.5,o.radius.value=f(4)*.8*10+n)})()});function h(e){c=e}return(e,l)=>(q(),S("div",{ref_key:"con",ref:a,class:"w-full h-full relative"},[V(P,{class:"absolute top-70px left-0","fft-size":p,onInitAudioAnalyser:h})],512))}});export{Q as default};
