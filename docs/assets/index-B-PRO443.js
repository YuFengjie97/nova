import{d as m,r as d,V as a,j as x,aV as p,aQ as g,ai as _,Y as h,e as y,o as z}from"./index-Dk52mj26.js";import{i as w}from"./initThree-CPuUtzyO.js";import"./OrbitControls-Rz_z-Chd.js";import"./initStats-z-qGLZo8.js";const M=`varying vec2 vUv;
...
}`,S="/nova/assets/textures_icon_3x3-BPZDTU0X.png",D=m({__name:"index",setup(B){const n=d(),o=new a(0,0);function u(e){const{height:r}=n.value.getBoundingClientRect();o.x=e.x,o.y=r-e.y}return x(()=>{const{scene:e,renderWrap:r}=w(n.value),{width:s,height:v}=n.value.getBoundingClientRect(),t={iResolution:{value:new a(s,v)},iMouse:{value:o},iTime:{value:0},size:{value:20},texture1:{value:new p().load(S)}},c=new g({uniforms:t,vertexShader:M,fragmentShader:T}),l=new _(1e3,1e3),i=new h(l,c);i.position.set(0,0,10),e.add(i),r(()=>{const f=performance.now()/1e3;t.iTime.value=f})()}),(e,r)=>(z(),y("div",{ref_key:"con",ref:n,class:"w-full h-full relative",onMousemove:u},null,544))}});export{D as default};
