import{d as x,r as f,h as g,V as h,aK as A,aa as w,M as S,o as T,b as F,e as R,t as z,_ as C}from"./index-CpijY5gs.js";import{i as I}from"./initThree-7ahq76Y7.js";import{m as M}from"./audio-sugarCrush-1d8eZUIK.js";import{i as P}from"./audio2-Bh-ajUVZ.js";import"./OrbitControls-DbIETR5g.js";import"./initStats-k2kTMle0.js";const b=`varying vec2 vUv;
...
}`,t=512,B=100,D=x({__name:"index",setup(V){const n=f(),{audio:a,getAnalyser:v}=P(M,t);let o;const i=new Float32Array(t),e=f(!1);function u(){a.paused?(a.play(),e.value=!0,o=v().analyser):(a.pause(),e.value=!1)}return setInterval(()=>{e.value&&o.getFloatTimeDomainData(i)},B),g(()=>{const{scene:r,renderWrap:l}=I(n.value),{width:d,height:m}=n.value.getBoundingClientRect(),s={iResolution:{value:new h(d,m)},iTime:{value:0},dataArray:{value:i},fftSize:{value:t}},p=new A({uniforms:s,vertexShader:b,fragmentShader:k}),_=new w(1e3,1e3),c=new S(_,p);c.position.set(0,0,10),r.add(c),l(()=>{const y=performance.now()/1e3;s.iTime.value=y})()}),(r,l)=>(T(),F("div",{ref_key:"con",ref:n,class:"con w-full h-full relative"},[R("div",{class:"bt",onClick:u},z(e.value?"pause":"play"),1)],512))}}),j=C(D,[["__scopeId","data-v-8ad3996f"]]);export{j as default};
