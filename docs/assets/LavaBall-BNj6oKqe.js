import{G}from"./dat.gui.module-DcMWPYuf.js";import{V as h,aM as b,aL as w,aK as g,N as O,d as X,r as U,h as A,aP as B,I as y,aQ as I,M as V,ae as W,S as Y,E as j,P as H,W as Z,G as q,H as $,C as J,o as ee,b as te,e as E,aN as ne,_ as ie}from"./index-CNxnBlAo.js";import{S as ae}from"./stats.module--VATS4Kh.js";import{O as re}from"./OrbitControls-vcj3RfCY.js";import{P as R,F,R as oe,E as se}from"./RenderPass-TRHkYC0D.js";const x={defines:{KERNEL_SIZE_FLOAT:"25.0",KERNEL_SIZE_INT:"25"},uniforms:{tDiffuse:{value:null},uImageIncrement:{value:new h(.001953125,0)},cKernel:{value:[]}},vertexShader:`
  ...
  `,k=new g({uniforms:l,vertexShader:d,fragmentShader:p});T=new V(new W(.65,32,16),k),f.add(T)}function N(){const u=new oe(f,m),d=new c(1.25),p=new ue(.35,.95,2048);v=new se(o),v.addPass(u),v.addPass(d),v.addPass(p)}function Q(){f=new Y,f.background=new j(4473924),m=new H(75,i/n,.1,1e3),o=new Z({canvas:e.value,antialias:!0}),o.setSize(i,n),o.setPixelRatio(window.devicePixelRatio),o.autoClear=!1,window.addEventListener("resize",z),f.add(new q(1e3)),f.add(new $(4210752)),r=ae(),t.value.append(r.dom),a=new re(m,o.domElement),a.target=new y(0,0,0),a.object.position.set(1,1,1),a.update()}let C=0;function _(){C=requestAnimationFrame(_),r.update(),P()}J(()=>{cancelAnimationFrame(C)});function z(){i=window.innerWidth,n=window.innerHeight,m.aspect=i/n,m.updateProjectionMatrix(),o.setSize(i,n)}return(u,d)=>(ee(),te("div",me,[E("div",{ref_key:"canvasCon",ref:t,class:"canvasCon"},[E("canvas",{ref_key:"canvasDom",ref:e,class:"canvas"},null,512)],512)]))}}),Se=ie(ve,[["__scopeId","data-v-b97af2ee"]]);export{Se as default};
