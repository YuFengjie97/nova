import{G as O}from"./dat.gui.module-DcMWPYuf.js";import{V as h,aS as b,aR as w,aQ as g,Z as G,d as V,r as U,j as W,aV as X,R as y,aW as I,Y,am as j,S as A,N as B,P as Z,W as H,O as q,Q as $,G as J,e as ee,f as R,aT as te,o as ne,_ as ie}from"./index-Dk52mj26.js";import{S as ae}from"./stats.module--VATS4Kh.js";import{O as re}from"./OrbitControls-Rz_z-Chd.js";import{P as E,F,R as oe,E as se}from"./RenderPass-BN88JlIK.js";const x={defines:{KERNEL_SIZE_FLOAT:"25.0",KERNEL_SIZE_INT:"25"},uniforms:{tDiffuse:{value:null},uImageIncrement:{value:new h(.001953125,0)},cKernel:{value:[]}},vertexShader:`
  ...
  `,k=new g({uniforms:l,vertexShader:d,fragmentShader:p});T=new Y(new j(.65,32,16),k),f.add(T)}function Q(){const u=new oe(f,m),d=new c(1.25),p=new ue(.35,.95,2048);v=new se(o),v.addPass(u),v.addPass(d),v.addPass(p)}function N(){f=new A,f.background=new B(4473924),m=new Z(75,i/n,.1,1e3),o=new H({canvas:e.value,antialias:!0}),o.setSize(i,n),o.setPixelRatio(window.devicePixelRatio),o.autoClear=!1,window.addEventListener("resize",z),f.add(new q(1e3)),f.add(new $(4210752)),r=ae(),t.value.append(r.dom),a=new re(m,o.domElement),a.target=new y(0,0,0),a.object.position.set(1,1,1),a.update()}let C=0;function _(){C=requestAnimationFrame(_),r.update(),M()}J(()=>{cancelAnimationFrame(C)});function z(){i=window.innerWidth,n=window.innerHeight,m.aspect=i/n,m.updateProjectionMatrix(),o.setSize(i,n)}return(u,d)=>(ne(),ee("div",me,[R("div",{ref_key:"canvasCon",ref:t,class:"canvasCon"},[R("canvas",{ref_key:"canvasDom",ref:e,class:"canvas"},null,512)],512)]))}}),Se=ie(ve,[["__scopeId","data-v-b97af2ee"]]);export{Se as default};
