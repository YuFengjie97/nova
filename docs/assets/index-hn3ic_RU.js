import{d as v,r as f,h as p,V as h,aG as d,a8 as u,M as m,b as x,o as b}from"./index-buY-64hZ.js";import{i as g}from"./initThree-oPrL-1t5.js";import"./OrbitControls-2G3I6IlV.js";import"./initStats-1oN1fAIq.js";import"./_commonjsHelpers-4gQjN7DL.js";const w=`varying vec2 vUv;
...
}`,B=v({__name:"index",setup(_){const e=f();return p(()=>{const{scene:n,renderWrap:t}=g(e.value),{width:i,height:s}=e.value.getBoundingClientRect(),o={iResolution:{value:new h(i,s)},iTime:{value:0}},c=new d({uniforms:o,vertexShader:w,fragmentShader:y}),r=new u(1e3,1e3),a=new m(r,c);a.position.set(0,0,10),n.add(a),t(()=>{const l=performance.now()/1e3;o.iTime.value=l})()}),(n,t)=>(b(),x("div",{ref_key:"con",ref:e,class:"w-full h-full relative"},null,512))}});export{B as default};
