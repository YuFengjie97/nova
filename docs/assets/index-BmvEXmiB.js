import{d as m,r as d,V as i,j as x,aX as p,aM as g,aH as _,ad as h,R as y,e as z,o as M}from"./index-CqfaNC88.js";const w=`varying vec2 vUv;
...
}`,S="/nova/assets/textures_icon_3x3-BPZDTU0X.png",C=m({__name:"index",setup(R){const n=d(),o=new i(0,0);function u(e){const{height:r}=n.value.getBoundingClientRect();o.x=e.x,o.y=r-e.y}return x(()=>{const{scene:e,renderWrap:r}=p(n.value),{width:s,height:v}=n.value.getBoundingClientRect(),t={iResolution:{value:new i(s,v)},iMouse:{value:o},iTime:{value:0},size:{value:20},texture1:{value:new g().load(S)}},c=new _({uniforms:t,vertexShader:w,fragmentShader:T}),l=new h(1e3,1e3),a=new y(l,c);a.position.set(0,0,10),e.add(a),r(()=>{const f=performance.now()/1e3;t.iTime.value=f})()}),(e,r)=>(M(),z("div",{ref_key:"con",ref:n,class:"w-full h-full relative",onMousemove:u},null,544))}});export{C as default};
