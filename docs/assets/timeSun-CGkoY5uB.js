import"./p5.min-8ea0dEJR.js";import{m as w}from"./math-6T_IkARJ.js";import{d as Y,r as o,h as _,c as $,C as A,o as F,b as P,e as u,n as l,u as c,t as z,_ as I}from"./index-D5VwQozy.js";const R=Y({__name:"timeSun",setup(j){const{floor:i,abs:s}=Math,f=o();let g=0;_(()=>{const{width:e}=f.value.getBoundingClientRect();g=e});const n=o(0),m=o(0),C=$(()=>{const e=1440*n.value,a=i(e/60),t=i(e-a*60);return m.value=a,`${h(a)}:${h(t)}`}),S=$(()=>{const t=-(n.value-.5)*40,x=s((n.value-.5)*30)+10;return X(t,x)}),p=o({x:0,y:0}),r=o(),d=o(0);function M(){if(!r.value)return;const e=.1,{width:a,height:t}=r.value.getBoundingClientRect(),x=(n.value*a-p.value.x)*e,O=(s(n.value-.5)*t-p.value.y)*e;p.value.x+=x,p.value.y+=O}let b=0;A(()=>{cancelAnimationFrame(b)});function v(){M(),b=requestAnimationFrame(v)}_(()=>{v()});function k(e){const{offsetX:a}=e,t=a/g;n.value=t,d.value=w(-s(t-.5),-.5,0,20,100)}const B=$(()=>`--color: hsl(37, 90%,${w(-s(n.value-.5),-.5,0,10,50)}%)`);function h(e){return e>=10?`${e}`:`0${e}`}function X(e,a){return e=-e*.1,a=a*.1,`
  text-shadow:
