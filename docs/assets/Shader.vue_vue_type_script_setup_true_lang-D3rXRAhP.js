import{d as w,r as y,j as g,V as p,aQ as _,ai as M,Y as S,e as D,o as z}from"./index-Dk52mj26.js";import{i as E}from"./initThree-CPuUtzyO.js";const T=`\r
...
`,P=w({__name:"Shader",props:{utils:{default:T},fs:{}},setup(l){const a=l,e=y();return g(()=>{var u,f,v;const{scene:o,renderWrap:s}=E(e.value),{width:h,height:c}=e.value.getBoundingClientRect(),n={iResolution:{value:new p(h,c)},iTime:{value:0},iMouse:{value:new p(0,0)}};let t=!1;(u=e.value)==null||u.addEventListener("mousedown",()=>t=!0),(f=e.value)==null||f.addEventListener("mouseup",()=>t=!1),(v=e.value)==null||v.addEventListener("mousemove",r=>{if(!t)return;const{x,y:b}=r;n.iMouse.value.x=x,n.iMouse.value.y=c-b});const m=new _({uniforms:n,vertexShader:k,fragmentShader:`
    ${a.utils}
    ${a.fs}
    `}),d=new M(1e3,1e3),i=new S(d,m);i.position.set(0,0,10),o.add(i),s(()=>{const r=performance.now()/1e3;n.iTime.value=r})()}),(o,s)=>(z(),D("div",{ref_key:"con",ref:e,class:"w-full h-full relative"},null,512))}});export{P as _};
