import{d as v,r as f,j as p,aZ as h,V as d,aJ as u,ag as m,U as x,e as b,o as g}from"./index-C5HxIGZc.js";const w=`varying vec2 vUv;
...
}`,W=v({__name:"index",setup(_){const e=f();return p(()=>{const{scene:n,renderWrap:t}=h(e.value),{width:i,height:s}=e.value.getBoundingClientRect(),o={iResolution:{value:new d(i,s)},iTime:{value:0}},c=new u({uniforms:o,vertexShader:w,fragmentShader:y}),r=new m(1e3,1e3),a=new x(r,c);a.position.set(0,0,10),n.add(a),t(()=>{const l=performance.now()/1e3;o.iTime.value=l})()}),(n,t)=>(g(),b("div",{ref_key:"con",ref:e,class:"w-full h-full relative"},null,512))}});export{W as default};
