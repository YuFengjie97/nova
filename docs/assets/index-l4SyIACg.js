import{d as w,r as b,j as z,aX as M,L as t,V as m,aH as R,ad as A,R as S,e as V,q,o as I}from"./index-CqfaNC88.js";import{A as P}from"./AudioController-DQ5RlVS_.js";import"./p5.min-WfQBoNak.js";import{m as T}from"./math-Cm0Zo__g.js";import"./audio-sugarCrush-1d8eZUIK.js";const k=`varying vec2 vUv;
...
}`,p=512,H=w({__name:"index",setup(F){const a=b();let c;z(()=>{const{scene:e,renderWrap:l}=M(a.value),{width:v,height:u}=a.value.getBoundingClientRect(),o={iResolution:{value:new m(v,u)},iMouse:{value:new m(v/2,u/2)},iTime:{value:0},colorChannel:{value:{a:new t(0,.5,.5),b:new t(0,.5,.5),c:new t(0,.5,.333),d:new t(0,.5,.667)}},radius:{value:0}},g=new R({uniforms:o,vertexShader:k,fragmentShader:B}),x=new A(1e3,1e3),s=new S(x,g);s.position.set(0,0,10),e.add(s);function y(n,r){const C=Math.floor(n/r),d=[];for(let i=0;i<n;i+=C)d.push(i);return d}const _=y(p/2,13);function f(n){const r=c.getAudioData()[_[n]];return T(r,0,255,0,1)}l(()=>{const n=performance.now()/1e3;o.iTime.value=n,c&&(o.colorChannel.value.a.x=f(5)*.5,o.radius.value=f(4)*.8*10+n)})()});function h(e){c=e}return(e,l)=>(I(),V("div",{ref_key:"con",ref:a,class:"w-full h-full relative"},[q(P,{class:"absolute top-70px left-0","fft-size":p,onInitAudioAnalyser:h})],512))}});export{H as default};
