import{d as v,r as f,h as p,V as u,aK as h,aa as m,M as d,o as x,b as g}from"./index-CpijY5gs.js";import{i as y}from"./initThree-7ahq76Y7.js";import"./OrbitControls-DbIETR5g.js";import"./initStats-k2kTMle0.js";const b=`varying vec2 vUv;
...
}`,D=v({__name:"index",setup(w){const n=f();return p(()=>{const{scene:e,renderWrap:r}=y(n.value),{width:a,height:i}=n.value.getBoundingClientRect(),t={iResolution:{value:new u(a,i)},iTime:{value:0}},l=new h({uniforms:t,vertexShader:b,fragmentShader:_}),s=new m(1e3,1e3),o=new d(s,l);o.position.set(0,0,10),e.add(o),r(()=>{const c=performance.now()/1e3;t.iTime.value=c})()}),(e,r)=>(x(),g("div",{ref_key:"con",ref:n,class:"w-full h-full relative"},null,512))}});export{D as default};
