import{G as B}from"./dat.gui.module-PWGADmkp.js";import{V as h,aN as b,aM as w,ax as g,N as G,d as H,r as U,h as X,aP as A,I as y,aQ as I,M as O,ae as V,S as W,E as Y,P as j,W as Z,G as q,H as J,C as $,o as ee,b as te,e as E,aO as ne,_ as ie}from"./index-Qb02CAS_.js";import{S as ae}from"./stats.module-nRd2dy6L.js";import{O as re}from"./OrbitControls-xf5Y9idm.js";import{P as R,F,R as oe,E as se}from"./RenderPass-aFRzBWIx.js";const x={defines:{KERNEL_SIZE_FLOAT:"25.0",KERNEL_SIZE_INT:"25"},uniforms:{tDiffuse:{value:null},uImageIncrement:{value:new h(.001953125,0)},cKernel:{value:[]}},vertexShader:`
  ...
  `,k=new g({uniforms:l,vertexShader:d,fragmentShader:p});T=new O(new V(.65,32,16),k),f.add(T)}function N(){const u=new oe(f,v),d=new c(1.25),p=new ue(.35,.95,2048);m=new se(o),m.addPass(u),m.addPass(d),m.addPass(p)}function z(){f=new W,f.background=new Y(4473924),v=new j(75,i/n,.1,1e3),o=new Z({canvas:e.value,antialias:!0}),o.setSize(i,n),o.setPixelRatio(window.devicePixelRatio),o.autoClear=!1,window.addEventListener("resize",Q),f.add(new q(1e3)),f.add(new J(4210752)),r=ae(),t.value.append(r.dom),a=new re(v,o.domElement),a.target=new y(0,0,0),a.object.position.set(1,1,1),a.update()}let C=0;function _(){C=requestAnimationFrame(_),r.update(),P()}$(()=>{cancelAnimationFrame(C)});function Q(){i=window.innerWidth,n=window.innerHeight,v.aspect=i/n,v.updateProjectionMatrix(),o.setSize(i,n)}return(u,d)=>(ee(),te("div",ve,[E("div",{ref_key:"canvasCon",ref:t,class:"canvasCon"},[E("canvas",{ref_key:"canvasDom",ref:e,class:"canvas"},null,512)],512)]))}}),Se=ie(me,[["__scopeId","data-v-b97af2ee"]]);export{Se as default};
