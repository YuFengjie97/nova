import{d as O,r as o,j as h,b as l,G as Y,e as A,f as $,n as u,t as F,B as w,o as P,_ as j}from"./index-Dk52mj26.js";const z=O({__name:"timeSun",setup(I){const{floor:c,abs:s}=Math,i=o();let f=0;h(()=>{const{width:e}=i.value.getBoundingClientRect();f=e});const n=o(0),g=o(0),_=l(()=>{const e=1440*n.value,a=c(e/60),t=c(e-a*60);return g.value=a,`${d(a)}:${d(t)}`}),S=l(()=>{const t=-(n.value-.5)*40,x=s((n.value-.5)*30)+10;return k(t,x)}),p=o({x:0,y:0}),r=o(),m=o(0);function B(){if(!r.value)return;const e=.1,{width:a,height:t}=r.value.getBoundingClientRect(),x=(n.value*a-p.value.x)*e,X=(s(n.value-.5)*t-p.value.y)*e;p.value.x+=x,p.value.y+=X}let v=0;Y(()=>{cancelAnimationFrame(v)});function b(){B(),v=requestAnimationFrame(b)}h(()=>{b()});function C(e){const{offsetX:a}=e,t=a/f;n.value=t,m.value=w(-s(t-.5),-.5,0,20,100)}const M=l(()=>`--color: hsl(37, 90%,${w(-s(n.value-.5),-.5,0,10,50)}%)`);function d(e){return e>=10?`${e}`:`0${e}`}function k(e,a){return e=-e*.1,a=a*.1,`
  text-shadow:
  ...
  `}return(e,a)=>(P(),A("div",{ref_key:"con",ref:i,class:"w-full min-h-full",style:u(`background: hsl(0,0%,${m.value}%)`),onMousemove:C},[$("div",{ref_key:"sunCon",ref:r,class:"relative w-full h-40vh overflow-hidden"},[$("div",{class:"sun",style:u([`transform: translate(calc(${p.value.x}px - 50%), ${p.value.y}px)`,M.value])},null,4)],512),$("div",{class:"time w-full h-30vh flex justify-center font-size-8rem color-#e0e0e0 select-none",style:u(S.value)},F(`${g.value>=12?"PM":"AM"} ${_.value}`),5)],36))}}),q=j(z,[["__scopeId","data-v-2738b6b5"]]);export{q as default};
