import{G as O}from"./dat.gui.module-DYGKXP-V.js";import{V as h,aJ as b,aI as w,aH as g,T as X,d as j,r as I,j as A,aM as B,L as U,aN as y,R as G,ah as V,S as W,I as Y,P as H,W as Z,J,K as q,O as $,C as ee,e as te,f as R,aK as ne,o as ie,_ as ae}from"./index-CqfaNC88.js";import{S as re}from"./stats.module--VATS4Kh.js";import{P as E,F,R as oe,E as se}from"./RenderPass-t97LsirO.js";const x={defines:{KERNEL_SIZE_FLOAT:"25.0",KERNEL_SIZE_INT:"25"},uniforms:{tDiffuse:{value:null},uImageIncrement:{value:new h(.001953125,0)},cKernel:{value:[]}},vertexShader:`
  ...
  `,k=new g({uniforms:l,vertexShader:d,fragmentShader:p});T=new G(new V(.65,32,16),k),f.add(T)}function N(){const u=new oe(f,v),d=new c(1.25),p=new ue(.35,.95,2048);m=new se(o),m.addPass(u),m.addPass(d),m.addPass(p)}function z(){f=new W,f.background=new Y(4473924),v=new H(75,i/n,.1,1e3),o=new Z({canvas:e.value,antialias:!0}),o.setSize(i,n),o.setPixelRatio(window.devicePixelRatio),o.autoClear=!1,window.addEventListener("resize",Q),f.add(new J(1e3)),f.add(new q(4210752)),r=re(),t.value.append(r.dom),a=new $(v,o.domElement),a.target=new U(0,0,0),a.object.position.set(1,1,1),a.update()}let C=0;function _(){C=requestAnimationFrame(_),r.update(),P()}ee(()=>{cancelAnimationFrame(C)});function Q(){i=window.innerWidth,n=window.innerHeight,v.aspect=i/n,v.updateProjectionMatrix(),o.setSize(i,n)}return(u,d)=>(ie(),te("div",ve,[R("div",{ref_key:"canvasCon",ref:t,class:"canvasCon"},[R("canvas",{ref_key:"canvasDom",ref:e,class:"canvas"},null,512)],512)]))}}),xe=ae(me,[["__scopeId","data-v-b97af2ee"]]);export{xe as default};
