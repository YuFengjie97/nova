import{d as v,r as f,j as p,aZ as u,V as h,aJ as d,ag as m,U as x,e as g,o as y}from"./index-Da-WdZGY.js";const b=`varying vec2 vUv;
...
}`,W=v({__name:"index",setup(w){const n=f();return p(()=>{const{scene:e,renderWrap:r}=u(n.value),{width:a,height:i}=n.value.getBoundingClientRect(),t={iResolution:{value:new h(a,i)},iTime:{value:0}},l=new d({uniforms:t,vertexShader:b,fragmentShader:_}),s=new m(1e3,1e3),o=new x(s,l);o.position.set(0,0,10),e.add(o),r(()=>{const c=performance.now()/1e3;t.iTime.value=c})()}),(e,r)=>(y(),g("div",{ref_key:"con",ref:n,class:"w-full h-full relative"},null,512))}});export{W as default};
