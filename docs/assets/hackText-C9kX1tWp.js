import{d as T,r as d,h as j,b as A,e as E,n as H,o as I,_ as N}from"./index-BkxFcAok.js";const o=200,x="123456789asfghjkl",P=T({__name:"hackText",setup(R){const{floor:s,random:a,ceil:f}=Math,h=d(),b=d(),g=d("");function e(r){let c="";for(let t=0;t<r;t++)c+=x.charAt(s(a()*x.length));return c}return j(()=>{const{width:r,height:c}=h.value.getBoundingClientRect(),t=f(c/o),n=f(r/o),p=o,k=p,v=p/2;let u="",m="",_="";for(let l=0;l<n;l++)for(let i=0;i<t;i++){const $=i*n+l===t*n-1?"":",",C=`rgb(${s(a()*255)},${s(a()*255)},${s(a()*255)})`;u+=`linear-gradient(90deg, ${C},${C})${$}`,m+=`${l*o}px ${i*o}px${$}`,_+=`${o}px ${o}px${$}`}const y=e(t*n),z=e(t*n),S=e(t*n),w=e(t*n),B=e(t*n),M=e(t*n);g.value=`
  --content1: ${y};
  --content2: ${z};
  --content3: ${S};
  --content4: ${w};
