import"./p5.min-WfQBoNak.js";import{m as h}from"./math-Cm0Zo__g.js";import{d as O,r as o,j as w,b as l,C as Y,e as A,f as $,n as u,t as F,o as P,_ as j}from"./index-CqfaNC88.js";const z=O({__name:"timeSun",setup(I){const{floor:c,abs:s}=Math,i=o();let f=0;w(()=>{const{width:e}=i.value.getBoundingClientRect();f=e});const p=o(0),g=o(0),_=l(()=>{const e=1440*p.value,a=c(e/60),t=c(e-a*60);return g.value=a,`${d(a)}:${d(t)}`}),C=l(()=>{const t=-(p.value-.5)*40,x=s((p.value-.5)*30)+10;return B(t,x)}),n=o({x:0,y:0}),r=o(),m=o(0);function S(){if(!r.value)return;const e=.1,{width:a,height:t}=r.value.getBoundingClientRect(),x=(p.value*a-n.value.x)*e,X=(s(p.value-.5)*t-n.value.y)*e;n.value.x+=x,n.value.y+=X}let v=0;Y(()=>{cancelAnimationFrame(v)});function b(){S(),v=requestAnimationFrame(b)}w(()=>{b()});function M(e){const{offsetX:a}=e,t=a/f;p.value=t,m.value=h(-s(t-.5),-.5,0,20,100)}const k=l(()=>`--color: hsl(37, 90%,${h(-s(p.value-.5),-.5,0,10,50)}%)`);function d(e){return e>=10?`${e}`:`0${e}`}function B(e,a){return e=-e*.1,a=a*.1,`
  ...
  `}return(e,a)=>(P(),A("div",{ref_key:"con",ref:i,class:"w-full min-h-full",style:u(`background: hsl(0,0%,${m.value}%)`),onMousemove:M},[$("div",{ref_key:"sunCon",ref:r,class:"relative w-full h-40vh overflow-hidden"},[$("div",{class:"sun",style:u([`transform: translate(calc(${n.value.x}px - 50%), ${n.value.y}px)`,k.value])},null,4)],512),$("div",{class:"time w-full h-30vh flex justify-center font-size-8rem color-#e0e0e0 select-none",style:u(C.value)},F(`${g.value>=12?"PM":"AM"} ${_.value}`),5)],36))}}),E=j(z,[["__scopeId","data-v-2738b6b5"]]);export{E as default};
